...
const About = () => {
  return (
    <section className="relative bg-black text-white pt-24 pb-32">
      {/* Invisible anchor for scroll alignment */}
      <span id="about" className="absolute -top-24" />

      <div className="container mx-auto px-12 md:px-24 lg:px-40" data-aos="fade-up">
        {/* About Me Title */}
        <h2 className="text-6xl font-extrabold text-center mb-16" data-aos="fade-down">
          About Me
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-16">
          ...
          <img
            src={AboutImage}
            alt="About"
            className="w-72 h-96 rounded-2xl object-cover mb-10 md:mb-0 shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:shadow-[0_0_25px_rgba(255,255,255,0.3)] transition duration-300"
            data-aos="zoom-in"
          />
          ...
          <div className="flex-1" data-aos="fade-left">
            ...
            <div className="space-y-6">
              <Skill label="HTML & CSS" width="w-10/12" />
              <Skill label="React JS" width="w-7/12" />
              <Skill label="Node JS" width="w-5/12" />
            </div>

            {/* Stats */}
            <div className="mt-14 flex justify-center gap-16 md:gap-24 text-center text-lg flex-wrap">
...
const Skill = ({ label, width }) => (
  <div className="flex items-center gap-5" data-aos="fade-right">
    <span className="text-lg w-[140px]">{label}</span>
    <div className="flex-1 bg-gray-800 rounded-full h-4">
      <div
        className={`bg-gradient-to-r from-green-400 to-blue-500 h-4 rounded-full ${width} transform transition-transform duration-300 hover:scale-105`}
      />
    </div>
  </div>
);
...
const Stat = ({ count, label }) => (
  <div data-aos="fade-up">
    <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 transform transition-transform duration-300 hover:scale-125 hover:drop-shadow-[0_0_8px_#34d399] cursor-default">
      {count}
    </h3>
    <p className="text-base text-gray-300 mt-1">{label}</p>
  </div>
);
